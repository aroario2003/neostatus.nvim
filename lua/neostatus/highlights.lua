...
vim.api.nvim_set_hl(0, 'StatusLineFilenameColorSaved', { fg = colors['magenta'], bold = true })
vim.api.nvim_set_hl(0, 'StatusLineFilenameColorMod', { fg = colors['yellow'], bold = true })
